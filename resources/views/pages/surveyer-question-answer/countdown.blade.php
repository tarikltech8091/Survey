        ...
        <div class="col-sm-12">
            <div class="tabbable">
                ...
                <div class="panel-body">
                    <form method="get"  action="{{url('surveyer/participate/countdown')}}">
				...
				@foreach($numberOfQuestions as $key => $list)
					...
					<div class="col-md-3" style="margin-top: 20px; padding-left: 50px;">
						<div class="report_view reprt_color_1 cursor dashborad_menus centered">
							...
							<p class="report_name">	
								<a href="{{url('/surveyer/participate/question-'.$list->answer_question_id)}}">{{$list->question_answer_title}} </a>
							</p><br>
