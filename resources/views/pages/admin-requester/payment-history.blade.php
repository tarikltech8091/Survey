			...
			<div class="row page_row_dash">
				...
				<div class="col-md-3">
					<div class="report_view reprt_color_1 cursor dashborad_menus centered">
						...
						<p class="report_name">	
							<a href="#">{{isset($requester_info->requester_total_invest)? $requester_info->requester_total_invest : '0'}}</a>
						</p>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="report_view reprt_color_1 cursor dashborad_menus centered">
						...
						<p class="report_name">	
							<a href="#">{{isset($requester_info->requester_total_paid)? $requester_info->requester_total_paid : '0'}}</a>
						</p>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="report_view reprt_color_1 cursor dashborad_menus centered">
						...
						<p class="report_name">	
							<a href="#">{{(isset($requester_info->requester_total_invest)? $requester_info->requester_total_invest : '0') - (isset($requester_info->requester_total_paid)? $requester_info->requester_total_paid : '0')}}</a>
						</p>
					</div>
				</div>
                ...
                <div class="col-md-3">
                    <div class="report_view reprt_color_1 cursor dashborad_menus centered">
                        <p class="report_name"> 
                            <a href="#">Number Of Campaign</a>
                        </p><br>
                        <p class="report_name"> 
                            <a href="#">{{isset($requester_info->requester_number_of_campaign)? $requester_info->requester_number_of_campaign : '0'}}</a>
                        </p>
                    </div>
                </div>
