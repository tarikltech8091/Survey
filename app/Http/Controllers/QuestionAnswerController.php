...
class QuestionAnswerController extends Controller
{
    ...
    ##  QuestionAnswer View
     *********************************************/
    public function QuestionAnswer($surveyer_id, $campaign_id, $question_id)
    {
        ...
        $data['select_question'] = \DB::table('question_tbl')->where('id',$question_id)->where('question_status','1')->orderby('id','desc')->first();
