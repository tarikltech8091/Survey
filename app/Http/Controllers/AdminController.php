...
class AdminController extends Controller
{
    ...
    *********************************************/
    public function CompanyPage(){
        ...
        $data['tab']=$tab;
        $company_info=\DB::table('company')->latest()->first();
         ...
         if($v->passes()){
            ...
            if($company_id!= null){
                ...
                if(!empty(\Request::file('company_logo'))){
                    ...
                    \DB::table('company')->where('company_id',$company_id)->update($company_update_img);
                 }
                    ...
                    try{
                        \DB::table('company')->where('company_id',$company_id)->update($company_update_data);
            ...
            try{
                \DB::table('company')->insert($company_data);

                \App\System::EventLogWrite('insert,company',json_encode($company_data));
